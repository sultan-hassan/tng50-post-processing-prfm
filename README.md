...
The data file (one downloaded using the above link) contains z=0 and z=2 maps, stored as pickled pandas objects  (/data/all_data_z0.pkl and /data/all_data_z2.pkl). Each file contains the following maps for each galaxy in the selected sample (see examples for how to read them)
